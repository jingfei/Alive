...
function handlename($data){
  ...
  if($_SERVER[REQUEST_METHOD]== POST){
    ...
    $job_description= handlename($_POST["job_description"]);
      ...
      $sql="UPDATE jobs SET job_name='$job_name',age_requirement='$age_requirement',time='$time',address='$address',phone_number='$phone_number',website='$website',job_description='$job_description' WHERE id=1";
      $conn->query($sql);
}
