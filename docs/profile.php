<<<<<<< HEAD
<?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><html><head>
=======
<<<<<<< HEAD

<?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><?php session_start(); ?><!DOCTYPE html><html><head>
    ...
    <div class="row col-md-6">
      <div class="col-md-12">
           ...
           <thead>
            ...
            <tbody>
          <?php while($row=$result2->fetch_assoc()) { ?><tr onclick="location.href='detail?jobid=<?php echo $row["id"];?>';"><td><?php echo $row["job_name"]; ?></td>
